...
@implementation TuyaAppTopBarView
...
- (void)setLeftItem:(TuyaAppBarButtonItem *)leftItem {
...
- (void)setRightItem:(TuyaAppBarButtonItem *)rightItem {
...
- (void)setCenterItem:(TuyaAppBarButtonItem *)centerItem {
