...
@interface TuyaAppCameraCalendarView() <UICollectionViewDataSource, UICollectionViewDelegate>
...
//IB_DESIGNABLE
@implementation TuyaAppCameraCalendarView

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:[UIScreen mainScreen].bounds]) {
        self.hidden = YES;
        [self.collectionView registerClass:[TuyaAppCameraCalendarCollectionViewCell class] forCellWithReuseIdentifier:CellIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TuyaAppCameraCalendarCollectionViewCell *cell = (TuyaAppCameraCalendarCollectionViewCell *)[collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifier forIndexPath:indexPath];
