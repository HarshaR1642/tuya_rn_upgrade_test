//
//  TuyaAppCameraMessageViewController.m
//  TuyaSDK
//
...
@implementation TuyaAppCameraMessageViewController
...
- (UITableView *)messageTableView {
    if (!_messageTableView) {
        CGFloat top = APP_TOP_BAR_HEIGHT;
        CGFloat height = self.view.size.height - APP_TOP_BAR_HEIGHT;
